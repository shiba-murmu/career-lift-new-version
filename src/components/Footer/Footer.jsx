...
//           {/* <h1>Career Lift</h1> */}
//           <div>
//             <span  style={{fontFamily: "Open Sans"}}>Career Lift</span>
//           </div>
//           <div>
//             <p>Career lift is the career guidance platfrom</p>
//           </div>
...
function Footer() {
  return (
    <>
      {/* <!-- Footer container --> */}
      <footer className="bg-zinc-50 text-center text-surface/75 dark:bg-blue-900 dark:text-white/75 lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
          ...
          <div className="flex justify-center">
            ...
            <a href="https://www.instagram.com/murmujsr/" className="me-6 [&>svg]:h-4 [&>svg]:w-4">
            {/* Instagram */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
            ...
            <a href="https://github.com/shiba-murmu" className="[&>svg]:h-4 [&>svg]:w-4">
            {/* GitHub */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
